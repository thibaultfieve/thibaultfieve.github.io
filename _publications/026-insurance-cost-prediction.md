...
permalink: /publications/insurance-cost-prediction
date: 2026-05-01
venue: 'ESLSCA Paris — MBA Data Science Project'
paperurl: '/files/insurance-cost-report.pdf'
---
...
It contains 1,338 observations from US health insurance beneficiaries with 7 
variables, reduced to 1,337 after dropping one exact duplicate.
...
test-set variance in log(charges). Random Forest achieves the best predictive 
accuracy with a **$1,089 MAE advantage** over OLS, statistically significant 
via paired bootstrap (95% CI [$702; $1,513]).

The five-tier risk segmentation derived from OLS prediction quintiles delivers 
an **11.8x cost ratio** between the top and bottom tiers.
